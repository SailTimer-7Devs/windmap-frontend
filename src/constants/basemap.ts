...
export const WNI_WIND_SPEED_PALETTE_1_40 = [
  [1, [55, 39, 104, 255]], // темний синьо-фіолетовий
  [2, [58, 49, 126, 255]], // темний синій

  [3, [62, 59, 149, 255]], // блакитний
  [4, [66, 79, 184, 255]],
  [5, [60, 110, 200, 255]], // синьо-блакитний
  [6, [60, 140, 215, 255]], // блакитний

  [7, [60, 170, 180, 255]], // перехід до зеленого
  [8, [60, 200, 140, 255]],
  [9, [60, 230, 100, 255]], // зелений
  [10, [120, 255, 60, 255]], // лайм
  [11, [180, 255, 30, 255]],
  [12, [255, 255, 0, 255]], // жовтий

  [13, [255, 220, 0, 255]], // помаранчевий
  [14, [255, 200, 0, 255]],
  [15, [255, 180, 0, 255]],
  [16, [255, 160, 0, 255]],
  [17, [255, 140, 0, 255]],
  ...
  [20, [255, 60, 0, 255]], // червоно-помаранчевий
  [21, [255, 30, 0, 255]],
  [22, [255, 0, 0, 255]], // червоний
  [23, [230, 0, 50, 255]],
  [24, [210, 0, 100, 255]],
  [25, [190, 0, 150, 255]],
  [26, [180, 0, 180, 255]], // фіолетовий
  [27, [175, 0, 175, 255]],
  [28, [170, 0, 170, 255]],
  [29, [165, 0, 165, 255]],
  [30, [160, 0, 160, 255]],
  ...
  [38, [142, 0, 142, 255]],
  [39, [141, 0, 141, 255]],
  [40, [140, 0, 140, 255]] // темний фіолетовий
]
...
export const WNI_SIGWH_PALETTE = [
  [0, [0, 60, 136, 255]],
  [5, [10, 75, 150, 255]],
  [10, [25, 95, 170, 255]],
  [15, [40, 120, 190, 255]],
